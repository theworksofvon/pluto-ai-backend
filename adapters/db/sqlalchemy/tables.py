...
class PlayerPrediction(Base):
    ...
    def __repr__(self):
        return (f"<PlayerPrediction(prediction_id={self.prediction_id}, game_id={self.game_id}, "
...
class GamePrediction(Base):
    ...
    game_id = Column(Integer, ForeignKey("games.game_id"), nullable=False)
    predicted_winner_team_id = Column(Integer, ForeignKey("teams.team_id"), nullable=False)
    timestamp = Column(DateTime, default=datetime.utcnow, nullable=False)

    game = relationship("Game")
    predicted_winner_team = relationship("Team", foreign_keys=[predicted_winner_team_id])
